...
public class Drivetrain extends SubsystemBase {
    ...
    private Drivetrain() {
        ...
        FLModule = new DifferentialModule(RobotMap.FL_DRIVE_ID_1, RobotMap.FL_DRIVE_ID_2, RobotMap.FL_ENCODER_ID, new Vector2d(11.375, 11.375));
        ...
        RRModule = new DifferentialModule(RobotMap.RR_DRIVE_ID_1, RobotMap.RR_DRIVE_ID_2, RobotMap.RR_ENCODER_ID, new Vector2d(-11.375, -11.375));
        // 8.875 vs. 11.375
...
//                FRModule.getModulePos(), FLModule.getModulePos(), RLModule.getModulePos(), RRModule.getModulePos());
        Vector2d[] driveVecs = SwerveMath.calculateDriveVector(robotHeading, transVecF, rotVal,
                FLModule.getModulePos(), RRModule.getModulePos());
        FLModule.setVectorPercent(driveVecs[0]);
        //FLModule.setVectorPercent(driveVecs[1]);
        RRModule.setVectorPercent(driveVecs[1]);
    ...
    public double[] getModuleAngles() {
        return new double[]{FLModule.getAngle(), RRModule.getAngle()};
    }

    public  double[] getModuleRPM() {
        return  new double[]{FLModule.getRPM(), RRModule.getRPM()};
    }
